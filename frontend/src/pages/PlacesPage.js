        ...
        <div>
            ...
            {action === 'new' && (
                <form>
                    ...
                    <p className="text-gray-500 text-sm">Title for your place shoule be short and classy as advertisement</p>
                    <input type="text" placeholder="title , for example : my lovely apparment"/>
                    <h2 className="text-2xl mt-4">Address</h2>
                    <p className="text-gray-500 text-sm">Address to this place</p>
                    <input type="text" placeholder="address"/>
                    <h2 className="text-2xl mt-4">Photos</h2>
                    <p className="text-gray-500 text-sm">mode = better</p>
                    <div className="flex">
                        <input type="text gap-2" placeholder={"Add using link...jpg"}/>
                    ...
                    <p className="text-gray-500 text-sm">select all perks of your places</p>
