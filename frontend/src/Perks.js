export default function Perks(selected , onChange) {
    ...
    function handleCbClick(ev) {
        ...
        if (checked) {
            // Add the checkbox name to the selected array
            perksItems.push(name);
            selected = perksItems;

            // onChange([...selected, name]);
        } else {
            perksItems = perksItems.filter((items)=> items!=name);
            selected = perksItems;
            // Remove the checkbox name from the selected array
